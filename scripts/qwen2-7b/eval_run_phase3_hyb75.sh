...
MODEL_DIR=$PROJ/results/qwen2-7b/phase3_hybrid_alpha0.75
OUT_ROOT=$PROJ/results_eval/qwen2-7b/phase3_hybrid_alpha0.75
...
export SAVE_JSON=$OUT_ROOT/alpacaeval/responses.json SHORTNAME="alp-hyb75"
...
export SAVE_JSON=$OUT_ROOT/poem/responses.json SHORTNAME="poem-hyb75"
...
export SAVE_JSON=$OUT_ROOT/story/responses.json SHORTNAME="story-hyb75"
