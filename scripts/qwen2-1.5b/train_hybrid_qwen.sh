...
# --- Paths for 100% Supervised Training ---
MODEL_PATH="/data/ananthu/gem_project/models/Qwen2-1.5B-Instruct"
# Use the full 100% tokenized dataset
...
OUTPUT_DIR="/data/ananthu/gem_project/results/qwen_1.5b_hybrid_run"
