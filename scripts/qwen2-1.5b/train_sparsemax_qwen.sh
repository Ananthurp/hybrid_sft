...
OUTPUT_DIR="/data/ananthu/gem_project/results/qwen_1.5b_sparsemax_run"
...
# --- Launch on 3 GPUs, with Optimized Batch Size ---
deepspeed --include localhost:0,1,3 ${TRAIN_SCRIPT_PATH} \
